...
#ifndef HOKUSAI_PARTICLE_SOURCE_INL
#define HOKUSAI_PARTICLE_SOURCE_INL
...
ParticleSource<ParticleT>::ParticleSource(const HReal& startTime_, const HReal& endTime_, const HReal& delay_, const HReal &spacing_, const Vec3r& position_, const Vec3r& orientation_, const Vec3r& scale_, const Vec3r& velocity_)
{
    position = position_;
...
template<typename ParticleT>
ParticleSource<ParticleT>::ParticleSource(const ParticleSource& source)
{
...
template<typename ParticleT>
ParticleSource<ParticleT>::ParticleSource()
{
...
template<typename ParticleT>
void ParticleSource<ParticleT>::init()
{
...
template<typename ParticleT>
std::vector<ParticleT> ParticleSource<ParticleT>::apply(const HReal time)
{
